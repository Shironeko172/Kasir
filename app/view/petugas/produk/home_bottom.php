<script>
    ...
    $(document).ready(function() {
        table = $(".table").DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: base_url + "petugas/produk/getdata",
                type: "post"
            },
            "columns": [{
                    "data": null,
    ...
    function diskon(kode) {
        ...
        $("#tambahdiskon").submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: base_url + "petugas/produk/diskon",
                data: {
                    diskon: $("#diskon").val(),
                    kode: kode,
    ...
    function edit(kode) {
        ...
        $.ajax({
            url: base_url + "petugas/produk/kategori",
            type: "get",
            dataType: "json",
        ...
        $("#edit").submit(function(e) {
            ...
            $.ajax({
                url: base_url + "petugas/produk/edit",
                data: formdata,
                type: "post",
                processData: false,
                contentType: false,
    ...
    function hapus(kode) {
        ...
        swal.fire({
            ...
            preConfirm: (result) => {
                $.ajax({
                    url: base_url + "petugas/produk/hapus",
                    data: {
                        namaproduk: data.namaproduk,
                        kode: kode
                    },
    ...
    function exportexcel() {
        ...
        $("#excel").submit(function(e) {
            ...
            $.ajax({
                url: base_url + "petugas/produk/export",
                data: formdata,
                type: "post",
                processData: false,
                contentType: false,
    ...
    function kurangistok(kode) {
        ...
        $("#kurangistok").submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: base_url + "petugas/produk/kurangistok",
                data: {
                    stok: $("#stok").val(),
                    kode: kode,
                    namaproduk: data.namaproduk
    ...
    function tambahstok(kode) {
        ...
        $("#menambahstok").submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: base_url + "petugas/produk/tambahstok",
                data: {
                    stok: $("#stok").val(),
                    kode: kode,
                    namaproduk: data.namaproduk
    ...
    function tambahdata() {
        ...
        $("#tambahdata").submit(function(e) {
            ...
            $.ajax({
                url: base_url + "petugas/produk/tambah",
                data: formdata,
                type: "post",
                processData: false,
                contentType: false,
    ...
    function tambahkt() {
        ...
        $("#tambahkt").submit(function(e) {
            ...
            swal.fire({
                ...
                preConfirm: (result) => {
                    $.ajax({
                        url: base_url + "petugas/produk/tambahkt",
                        data: formdata,
                        type: "post",
                        processData: false,
                        contentType: false,
