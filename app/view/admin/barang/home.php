<div class="container">
    <div class="card card-body">
        <div class="row">
            ...
            <div class="col-lg-2">
                <button onclick="ExportExcel()" class="btn btn-success"><i class="bi bi-filetype-xlsx"></i> Export Ke Excel</button>
            </div>
            <div class="col-lg-12">
                <hr>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="modal-title">Export Ke Excel</h3>
                        <hr>
                    </div>
                    <form id="excel">
                        <div class="col-lg-12 mb-3">
                            ...
                            <span class="form-text" id="awal">Pilih Tanggal Awal Untuk Di Export</span>
                        </div>
                        <div class="col-lg-12 mb-3">
                            <label for="akhir" class="form-label">Tanggal Akhir</label>
                            <input type="date" class="form-control" id="akhir">
                            <span class="form-text" id="akhir">Pilih Tanggal Akhir Untuk Di Export</span>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary" type="submit" style="width: 100%;">Export</button>
                        </div>
                    </form>
                </div>
            </div>
