...
class petugas extends SENE_Controller
{
    ...
    function gantipassword()
    {
        ...
        $laporan = [
            ...
            "pelaku" => "admin",
            "kejadian" => "Admin " . $sess->admin->nama . " Telah Mengganti Password Petugas " . $nama
        ];
    ...
    function tambah()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "admin",
            "kejadian" => "Admin " . $sess->admin->nama . " Telah Menambah Petugas Baru Dengan Nama " . $data["nama"]
        ];
        $this->hm->insert($laporan);
        $this->pm->insert($data);
    }
