...
class Produk extends SENE_Controller
{
    ...
    function index()
    {
        ...
        $this->setTitle("Mengelola Produk");
    ...
    function diskon()
    {
        ...
        $laporan = [
            ...
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Menambah Diskon Produk " . $namaproduk
        ];
    ...
    function edit()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Mengubah Data Produk " . $namaproduk . " Menjadi " . $data["namaproduk"] . " , " . $data["kategori"] . " , " . number_format($data["harga"], 2, ",", ".")
        ];
        $this->hm->insert($laporan);
        $this->pm->update($kode, $data);
    }
    function export()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Mengambil Laporan Stok Dari Tanggal " . $awal . " Sampai " . $akhir
        ];
        $this->hm->insert($laporan);
    ...
    function hapus()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Menghapus Produk " . $namaproduk
        ];
        $this->hm->insert($laporan);
        $this->pm->update($kode, $data);
    }
    function tambahstok()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Menambah Stok Sebanyak " . $stok
        ];
    ...
    function kurangistok()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Mengurangi Stok Sebanyak " . $stok
        ];
    ...
    function tambah()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Menambah Produk Baru Dengan Nama Produk " . $data["namaproduk"]
        ];
        $this->hm->insert($laporan);
        $this->pm->insert($data);
    }
    function tambahkt()
    {
        ...
        $laporan = [
            "waktu" => date("Y-m-d h:i:s"),
            "pelaku" => "petugas",
            "kejadian" => "petugas " . $sess->petugas->nama . " Telah Menambah Kategori " . $data["kategori"]
        ];
        $this->hm->insert($laporan);
