...
class Barang extends SENE_Controller
{
    ...
    function tambah()
    {
        ...
        $laporan = [
            ...
            "kejadian" => "petugas " . $sess->petugas->nama . " Menambah Data Produk " . $data["namabarang"]
        ];
    ...
    function edit()
    {
        ...
        $laporan = [
            "tanggalwaktu" => date("Y-m-d h:i:s"),
            "kejadian" => "petugas " . $sess->petugas->nama . " Mengubah Data Produk " . $namabarangril . " Menjadi Produk " . $data["namabarang"] . ", Kategori: " . $data["kategori"] . ", Stok: " . $data["stok"] . " Pcs, Harga: Rp." . number_format($data["harga"], 2)
        ];
        $this->hm->insert($laporan);
    ...
    function hapus()
    {
        ...
        $laporan = [
            "tanggalwaktu" => date("Y-m-d h:i:s"),
            "kejadian" => "petugas " . $sess->petugas->nama . " Menghapus Data Produk " . $this->input->post("namabarang")
        ];
        $this->hm->insert($laporan);
        $this->bm->update($kode, $data);
    }
    ...
    function stok()
    {
        ...
        $laporan = [
            "tanggalwaktu" => date("Y-m-d h:i:s"),
            "kejadian" => "petugas " . $sess->petugas->nama . " Menambah Stok Produk " . $namabarang . " Sebanyak " . $stok
        ];
        $this->hm->insert($laporan);
    ...
    function diskon()
    {
        ...
        $laporan = [
            "tanggalwaktu" => date("Y-m-d h:i:s"),
            "kejadian" => "petugas " . $sess->petugas->nama . " Menambah diskon Produk " . $namabarang . " Sebanyak " . $diskon["diskon"] . "%"
        ];
        $this->hm->insert($laporan);
